...
(2026-09-10), docs/walled_nozzle_grid_and_wall.md. Reproduced as written, so
...
This is the second return, W10-W24, answering N9 items 1-7 and N16. The first
return, W1-W9, is docs/walled_nozzle_answers_from_impact_sim.md and still
stands except where an item here says otherwise.

Five of this decision's positions do not survive it, and they are reversed in
ADR-0016 rather than edited out of the text below: the cooler chamber (W17),
water's near-tie at the cold end (W21), the water-plus-hydrogen configuration
(W22), the 2,000 K exit target (W20), and the self-healing throat (W15).

Every table quoted in the ADR was re-checked against this repository's own
committed CSVs under data/results/walled_nozzle/ before being applied, not
