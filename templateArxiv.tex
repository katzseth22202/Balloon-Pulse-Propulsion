...
Rather than relying on active solar tracking in the dim polar sunlight, solar farms can be placed in polar sun-synchronous tracking orbits around Ceres. In orbit, solar panels and lenses avoid the thermal cycling challenges posed by Ceres' night. Thanks to its low gravity, mined carbon and water can be lofted into orbit with minimal propulsion, then converted into fuel at orbital solar farms. This fuel can power return trips to the surface and drive mining operations.

Unlike Phoebe, Ceres lacks a nearby planetary body for Oberth maneuvers. However, PuffSats returning from solar periapsis can deliver momentum for high-$\Delta V$ trajectories—either back to Earth or towards close perihelion. These returning PuffSats also offer an alternative to solar power. Their controlled impacts can be used to explosively excavate rocky overburden and melt large quantities of subsurface ice, enabling easy pumping to fill new PuffSats.
