...
While PuffSat navigation enables millimeter-scale centering in front of the pusher plate prior to detonation, gas generation unfolds over a finite duration and lacks comparable precision along the thrust axis. Nevertheless, sub-centimeter lateral positioning ensures that the plume impinges symmetrically to preserving the target vehicle’s inertial stability.
