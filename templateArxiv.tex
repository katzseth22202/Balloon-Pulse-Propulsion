...
\begin{table}[!htpb] % tabularx should be inside a table environment
    ...
    \begin{tabularx}{\textwidth}{|p{4em}|p{4em}|p{4em}|p{6em}|L|}\hline
        ...
        20.94 & 69.272 & 0 & 4.44 & Balloons approach Earth from Jupiter retrograde Hohmann trajectory and push the object to escape velocity and then to a periapsis near Parker Space probe \\\hline
        38.629 & 69.272 & 0 & 1.962 & Balloons approach Earth from Jupiter retrograde Hohmann trajectory and push the object to escape velocity and then to a periapsis near Parker Space probe but in a retrograde orbit around the Sun \\\hline
        10.916 & 69.272 & 0 & 9.331 & Balloons approach Earth from Jupiter and push a rocket into an elliptical orbit \\\hline
        3 and 3.7 & 7.20 & 0 & 1.455 & Launch balloons from the moon to trans-lunar injection orbit with low periapsis on Earth \\\hline
        0 & -2.38 & 2.38 & 2.30 & Decelerate trans-lunar payloads to land on the moon \\\hline
        24.98 & 35.25 & 0 & 1.29 & Balloons approach Saturn from Phoebe and push a Helium-3 payload into a temporary very low orbit around Saturn \\\hline
    \end{tabularx}
\end{table}
