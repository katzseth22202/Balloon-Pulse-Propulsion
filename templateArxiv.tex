...
Each PuffSat carries perhaps \SI{250}{\gram} of non-volatile solid mass, including sensors, power systems, microthrusters, and low bandwidth communication links to the coordinator nodes. To prevent this mass from impacting the rocket, we propose several disposal strategies:
