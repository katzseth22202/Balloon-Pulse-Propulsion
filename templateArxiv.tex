...
High vacuum can be also maintained using NEG (non-evaporable getter) \cite{neg_coatings} thin film coatings placed at intervals along the tube, which chemically absorb reactive atoms. To achieve low temperatures at high altitudes, small tube sections can leverage both passive radiative cooling via high-albedo “solar white” films \cite{ted_ed_2025_how_close} and active refrigeration from ultralight solar-powered units.  At these cold spots, we use small-scale cryopumping to remove noble gases like argon and other chemicals that NEG coatings can't adsorb.
