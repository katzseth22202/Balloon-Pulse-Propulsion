...
\item If our balloon interceptions occur at night, subsequent daytime interceptions will be over a warmer atmosphere with higher drag at the same altitude.
\end{itemize}
...
Instead of launching our lunar volatiles towards Earth with conventional rocket fuel, we launch off the moon using the same externally pulsed propulsion we've been discussing for terrestrial launches.   A rocket launched with external pulsed propulsion from the lunar surface into a trans lunar injection orbit can burn its engines at periapsis around Earth.  Due to the Oberth effect a small burn near Earth returns the rocket to the moon with a significant velocity change.   These returning balloons can push a new, more massive rocket filled with fresh volatiles off the moon, and then we repeat the cycle for exponential growth in balloon launch mass capacity.   We've reduced combustible fuel requirements by burning near Earth.

However, we ideally don't want to make any chemical rocket fuel at all.   Let's again use external propulsion to launch our balloons into a trans-lunar orbit, as before.   Then we launch a second set of balloons into a retrograde orbit.   Using the millimeter precision navigation techniques we've discussed, we collide these retrograde balloons with the more massive prograde balloons the main rocket is carrying.  We trap the exploding gas from these collisions in a pulsed reaction chamber and redirect this gas for thrust.    

Suppose  \(m_{rb}=\frac{m_{pb}}{3}\) where \(m_{rb}\) is the mass of a retrograde balloon and \(m_{pb}\) is the mass of a prograde balloon on the main rocket we're trying to propel.   If they collide at \SI{11}{\kilo\meter\per\second}, then the gas can be expelled at up to \SI{11}{\kilo\meter\per\second} for an effective delta-v = \SI {5.5}{\kilo\meter\per\second} after subtracting momentum lost when the retrograde balloon impact is accounted for.  Suppose this pulsed reaction has significant real world losses for an effective delta-v around \SI {3}{\kilo\meter\per\second}.   If the main rocket accelerates at it's Earth periapsis with a burn of \SI{1.5226}{\kilo\meter\per\second} it will reach the moon at \SI{6.42}{\kilo\meter\per\second}.   That's enough to start an exponential growth cycle where each loop around the moon launches about 1.6 times the starting mass.   If we do this once per month, we have increased our initial launch mass capacity by a factor of 1 million in only about 2.5 years.

\subsection{Lunar Oxygen Has Mass And That's All It Needs}
Lunar volatiles like water ice are ideal for filling balloons, but they are scarce.   However, oxygen is very common in lunar surface minerals.   Using solar energy and mining rovers derived from platforms like the IPex Pilot Excavator \cite{ipex_pilot_excavator}, we can produce oxygen.  On the volatiles depleted moon, finding something to burn oxygen with is hard.   However, externally pulsed propulsion does not require oxygen \textit{combustion}, just gas momentum.  In shadowed craters or artificial shade, lunar derived oxygen will liquify and perhaps even solidify for storage.   We use some of our lunar balloons to launch solar panels, electronics, pulsed reaction chambers, and other advanced components from Earth to the moon.   We can use externally pulsed propulsion to decelerate them at the moon with balloons launched from the moon's surface.  This deceleration minimizes conventional rocket fuel required for lunar landings.  We use the rest of our lunar balloons to exponentially grow our balloon mass capacity in orbit.  Even though lunar regolith will likely degrade rovers, solar concentrator, and solar panels faster than they would degrade on Earth, they may produce propulsion at costs that make hypersonic travel scalable at competitive costs.
