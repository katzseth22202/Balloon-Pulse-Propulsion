...
Our hypervelocity PuffSats employ formation-flying algorithms for precise positioning, but with a greater margin for error than VISORS or Proba-3. Those missions demanded sub-arcsecond pointing for imaging, whereas PuffSats can tolerate wider rotational misalignments and still satisfy mission objectives. Similarly, a formation with a standard deviation \SI{5}{\centi\meter} off-center pusher-plate impact may be acceptable, relaxing lateral control requirements.
