...
The Outer Space Treaty \cite{outer_space_treaty}prohibits nuclear weapons in space, so the legality of pure fusion rockets like those discussed in \autoref{sec:epstein_drives}, which rely on controlled nuclear reactions but are not weapons, requires clarification, likely through international dialogue and new legal frameworks.
