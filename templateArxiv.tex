...
Two control jobs shape what replaces the tank. Sustained drag and torque cancellation needs throttleable thrust near \SI{400}{\milli\newton} held for minutes, which favors a metered feed of liquid or generated gas. Brief attitude and divert corrections need fast, discrete impulses, which favor a bank of pre-measured solid charges. A single PuffSat can carry more than one of the forms below, matched to these jobs.
