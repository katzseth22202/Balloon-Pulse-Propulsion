...
Paralleling their role in consumer AI, neural networks offer a promising avenue to extend current CubeSat formation flying algorithms with the precise control required for this PuffSat pulsed propulsion (see \autoref{sec:neural_navigation}).
...
Leveraging gravity assists and the Oberth effect \cite{oberth_effect}, hypervelocity PuffSat impacts could achieve high energy densities and specific impulses.  Recent CubeSat formation flying and neural network advancements make the extremely precise navigation for this PuffSat pulsed propulsion viable (see \autoref{sec:neural_navigation}).  
...
If frozen materials prove impractical, the grid could instead be constructed from low-mass plastic explosives, designed to detonate on PuffSat impact. In the event of a missed PuffSat interception, this explosive grid would unfortunately persist as space debris for hours or days until eroded by atomic oxygen or decelerated by atmospheric drag. Another alternative is to replace ice lattices with liquid sprays that induce a shock detonation of the PuffSat’s explosives upon impact.
...
PuffSats filled with lunar ISRU ice do not primarily rely on chemical reactions to gasify. Their high-tensile skins absorb sunlight, melting the ice to water under mild pressure. Small explosives or an ice grid impactor, as described in \autoref{sec:explosive_puffsat}, rupture the skin to release the water. However, this process is too slow to fully vaporize the water before impact, and rapid vaporization would cool the stream so quickly that ice crystals reform.

Instead, we atomize the water into fine droplets, a process that requires far less energy than full vaporization. Atomization occurs via a combination of explosive detonation and aerodynamic shear as the PuffSat ruptures and collides with the ice sheet. To enhance this process, we suspend microscopic explosive particles in the water. These particles could be dispersed as a colloidal slurry or encapsulated in microbubbles to ensure uniform distribution.  We select micro explosives with calibrated shock sensitivity, designed to reliably detonate upon high velocity impact with the ice sheet or in response to the primary detonation charges that rupture the PuffSat skin.  While likely imported from Earth due to manufacturing complexity, the suspended micro explosive mass is small compared to the bulk water payload.

Additional ice particles injected by the rocket into the oncoming plume can mix with the atomized stream.  
This injected ice promotes further atomization and partial vaporization before plate contact.

\subsubsection{Liquid Oxygen PuffSats}
PuffSats filled with lunar oxygen (see \autoref{sec:lunar_mining}) must also atomize before reaching the pusher plate. To retain liquid oxygen during orbital transit, these PuffSats require thicker skins capable of withstanding elevated internal pressures. Highly reflective coatings help maintain cryogenic temperatures even in direct sunlight, minimizing boil-off of the pressurized liquid oxygen.

Upon rupture, however, the thicker balloon skin risks becoming hazardous shrapnel. To mitigate this, the rocket releases a denser intercepting ice sheet that fragments the skin on impact in a process analogous to how Whipple shielding breaks up space debris into less threatening dust \cite{whipple_shield}.

As with the icy PuffSats discussed in \autoref{sec:icy_puffsat}, the liquid oxygen is atomized through a combination of micro explosive detonation, aerodynamic shear, and shock interaction with the ice sheet. Microscopic explosive particles are again suspended in the oxygen to disperse the fluid into fine droplets. 
...
At low periapsis, however, drag, debris impacts, and radiation pressure make control difficult. Large balloon surface area also demands more polymer, increasing costs significantly. If high-performance polymer costs drop substantially, balloon PuffSats could become a favorable option.
...
We use some of our lunar PuffSats for the pulsed propulsion to lift terrestrial suborbital supply rockets into low Earth orbit.  The supplies include solar panels, pusher plates, PuffSat skins, electronics, and rovers. These supply rockets then use conventional engines to gain \(\Delta V\) so they can resupply our lunar surface operations.   When they reach the moon, we also use PuffSat pulsed propulsion to decelerate for lunar landing.  The deceleration propulsion PuffSats would previously have been launched from the moon's surface into an eccentric lunar orbit opposite to the incoming supplies' velocity.   We can optionally reduce terrestrial resupply requirements by embracing basic lunar manufacturing using metals like iron that are byproducts of lunar oxygen production.  These lunar metals could be shaped into pusher plate and pulsed propulsion chamber components.  
...
If the basic physics of PuffSat pulsed propulsion work, we'd likely proceed with different technologies in different time frames.  A asprirational "Elon time" \cite{wiktionary_elon_time} roadmap of when each technology could be  developed is proposed in \autoref{tab:schedule_future_work}.
