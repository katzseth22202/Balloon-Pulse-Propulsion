...
Recently successful missions like Proba-3 \cite{esa_proba_3} show that millimeter-scale formation flying works in high altitude orbits. This suggests most PuffSat navigation and control tasks can rely on established methods like robust MPC and Kalman filtering.   If necessary for the PuffSat's more demanding orbital setting near low periapsis, conventional methods may be augmented with neural networks (see \autoref{sec:neural_navigation}).
