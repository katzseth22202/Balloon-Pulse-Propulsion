...
Recently successful high precision orbital formation flying missions like Proba-3 \cite{esa_proba_3} suggest that PuffSat interception at millimeter-scale precision is achievable. While most navigation and control tasks can rely on established methods like robust MPC and Kalman filtering, selective use of neural network learned estimators may help when operating in the PuffSat's more perturbed environments near orbital periapsis (see \autoref{sec:neural_navigation}).
