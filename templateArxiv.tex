...
A key question is the ratio of the total external balloon mass required to propel the rocket mass to its final velocity. Project Orion concluded that these pusher plate collisions could be opaque \cite{orion_reflections}, suggesting relatively little kinetic energy is lost to heating the pusher plate and thus a more elastic collision. Furthermore, a curved, roughly parabolic pusher plate should ensure high collimation of the reflected gas. Therefore, we use a high estimated fudge factor of e=0. in the balloon ratio equation derived in Equation \autoref{eq:balloon_ratio}.
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{|c|c|c|c|X|}\hline 
        \textbf{Rocket \(v_{rf}\) (\SI{}{\km\per\second})} & \textbf{Balloon \(v_b\) (\SI{}{\km\per\second})} & \textbf{Rocket \(v_{ri}\) (\SI{}{\km\per\second})} & \textbf{Ratio} & \textbf{Scenario} \\\hline
        7.784 & 10.916 & 0  & 1.28           & Eccentric balloons with apogee at lunar distance pushes rocket to minimal low Earth orbit\\\hline
        0 & 7.784 & 7.784 & 2.308 & Decelerate the rocket for powered reentry with retrograde balloons in low orbit \\\hline
    \end{tabularx}
\end{table}
