...
Operating at a lower interception altitude (\SI{200}{\kilo\meter}) introduces stronger and more variable drag perturbations than at VISORS’s \SI{600}{\kilo\meter} orbit. However, PuffSats operate for only a single orbit, allowing a greater fraction of the micro-thruster budget to be dedicated to aggressive drag correction. To manage this environment, a hybrid propulsion system may be required: chemical micro-thrusters for primary maneuvers and cold-gas actuators for fine adjustments. Aerodynamic shaping of the PuffSats can further reduce sensitivity to drag fluctuations, though variability at this altitude remains a major source of uncertainty.
