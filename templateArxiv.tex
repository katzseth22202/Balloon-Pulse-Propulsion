...
We could analyze the volatiles we're extracting to see if they contain homochiral organic molecules, which are only produced by living organisms.   Studying samples that contain homochiral molecules could reveal much of Earth's biological history, including how life began. And, of course, the discovery of dinosaur DNA would surely delight \textit{Jurassic Park} \cite{jurassic_park} fans.
...
\]
We use a pessimistic \(I_{\mathrm{sp}}=\SI{25}{\s}\), about half a typical CubeSat cold-gas value to account for miniaturization losses. This gives
\[
