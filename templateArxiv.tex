...
Unlike PACER, our proposal does not produce radioactive waste or encourage the mass production of nuclear weapons.   If a liquid wall proves necessary to protect the chamber walls, it can be made from cheap materials like water.  We don't need to breed or extract tritium.   The most important difference is we don't need a biological shield to contain radioactive waste.  That means the steam can directly drive turbines, enabling much more scalable heat exchange with the environment.   This key difference enables terawatt sized plants that produce the necessary economies of scale for this electricity generation strategy to be profitable. 
