...
Batteries are environmentally attractive, but our world still depends heavily on fossil fuels.  Very low cost power can cheaply produce hydrocarbon fuels from water and carbon dioxide.  For example, in the cerium oxide cycle \cite{CeriaThermoCycles}, cerium oxide reduction occurs at high temperatures and low pressures.  Low pressures simplify vacuum chamber and air lock design (See \autoref{sec:vacuum_tube_details}.  Reduced cerium oxide can then be run over carbon dioxide and water to produce carbon monoxide and hydrogen.  These feedstock can then facilitate hydrocarbon production in reactors using well established techniques.   Since this hydrocarbon production would not require expensive electrical generation equipment and involves easier vacuum tube maintenance, it would likely be very economically compelling. 
