...
High vacuum can be also maintained using NEG (non-evaporable getter) \cite{neg_coatings} thin film coatings placed at intervals along the tube, which chemically absorb reactive atoms. At higher altitudes, either advanced thin-film radiators made from high-albedo “solar white” materials \cite{ted_ed_2025_how_close} or small solar powered refrigerators can cool small tube sections to low temperatures. At these cold spots, we can apply very small-scale cryopumping for noble gases like argon and other chemicals that NEG coatings can't remove.
